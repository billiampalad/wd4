...
<html lang="id" data-theme="light"
    class="{{ request()->routeIs('pusat.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }} {{ request()->routeIs('pusat.institusi') ? 'institusi-page' : '' }} {{ request()->routeIs('pusat.evaluasi') ? 'evaluasi-kinerja-page' : '' }}">
