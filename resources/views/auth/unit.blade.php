...
<html lang="id" data-theme="light"
    class="{{ request()->routeIs('unit.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }}">
...
<body class="{{ request()->routeIs('unit.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }}">
