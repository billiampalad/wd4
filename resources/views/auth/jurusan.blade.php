...
<html lang="id" data-theme="light"
    class="{{ request()->routeIs('jurusan.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }} {{ request()->routeIs('jurusan.institusi') ? 'institusi-page' : '' }} {{ request()->routeIs('jurusan.evaluasi') ? 'evaluasi-kinerja-page' : '' }} {{ request()->routeIs('jurusan.referensi.bentuk-kegiatan') ? 'bentuk-kegiatan-page' : '' }}">
