...
<html lang="id" data-theme="light"
    class="{{ request()->routeIs('jurusan.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }} {{ request()->routeIs('jurusan.institusi') ? 'institusi-page' : '' }} {{ request()->routeIs('jurusan.evaluasi') ? 'evaluasi-kinerja-page' : '' }}">
