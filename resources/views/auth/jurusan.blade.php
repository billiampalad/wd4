...
<body>
            ...
            <div class="nav-actions">
                ...
                <button class="icon-btn" id="notificationBtn" title="Notifications">
                    ...
                    @if(isset($notifikasiTerbaru) && $notifikasiTerbaru->count() > 0)
                        <span class="notification-badge">{{ $notifikasiTerbaru->count() }}</span>
                    @endif
                </button>
    ...
    <div class="layout">
        ...
        <aside id="sidebar">
            ...
            <div class="menu-section">KERJASAMA JURUSAN</div>

            <a class="menu-item {{ request()->routeIs('jurusan.dashboard') ? 'active' : '' }}" href="{{ route('jurusan.dashboard') }}">
                <div class="menu-icon"><i class="fas fa-home"></i></div>
                <span>Dashboard</span>
            </a>

            <a class="menu-item {{ request()->routeIs('jurusan.dkerjasama', 'jurusan.kerjasama.*') ? 'active' : '' }}" href="{{ route('jurusan.dkerjasama') }}">
