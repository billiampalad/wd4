            ...
            <div class="ud-hero-copy">
                ...
                <div class="ud-title-row">
                    ...
                    <div class="ud-title-copy">
                        <h2 class="ud-title" id="pageTitle">Tambah Penempatan Mahasiswa</h2>
                        <p class="ud-subtitle" id="pageDesc">
                            Daftarkan penempatan mahasiswa ke mitra industri untuk kegiatan magang, penelitian, atau
                            pelatihan.
                        </p>
                    </div>
                </div>
        ...
        <div class="card um-card dk-card" style="width: 100%; border-radius: 16px; overflow: visible;">
            <div class="card-header um-header dk-card-header">
                <div class="um-title dk-card-title">
                    ...
                    <span>
                        <strong>Formulir Penempatan Mahasiswa</strong>
                        <small>Lengkapi data penempatan mahasiswa, mitra industri, periode, dan pembimbing terkait.</small>
                    </span>
                </div>
            </div>
                                            ...
                                            <div class="mc-group">
                                                ...
                                                <div class="mc-input-wrap">
                                                    ...
                                                    <input type="date" name="periode_mulai"
                                                        value="{{ old('periode_mulai', date('Y-m-d')) }}" required
                                                        class="mc-input" />
                                                </div>
                                            </div>
                                        </div>
