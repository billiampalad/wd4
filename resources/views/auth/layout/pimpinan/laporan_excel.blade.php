    ...
    <tbody>
        @foreach($data as $index => $item)
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; vertical-align: top; white-space: pre-wrap;">{{ $tujuanText }}</td>
                <td style="border: 1px solid #000; vertical-align: top; white-space: pre-wrap;">{{ $sasaranText }}</td>
                ...
                <td style="border: 1px solid #000; vertical-align: top; white-space: pre-wrap;">{{ $dokumentasi ?: '-' }}</td>
