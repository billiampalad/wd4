...
<main id="mainContent" class="sk-page">
    ...
    <section class="dk-stat-grid" style="grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); margin-bottom: 24px;">
        ...
        <div class="dk-stat-card dk-stat-success">
            ...
            <div class="dk-stat-content">
                ...
                <div class="dk-stat-value" style="font-size: 15px; font-weight: 700; line-height: 1.2; margin-top: 4px;">
                    {{ $mostFrequentName }}
                        ...
                        @forelse ($statusList as $status)
                            <tr class="um-row dk-row">
                                ...
                                <td class="um-td" style="vertical-align: middle;">
                                    <span class="dk-status {{ $status['badge'] }}" style="font-weight: 700; font-size: 13px; text-transform: capitalize; padding: 4px 12px; display: inline-flex; align-items: center; justify-content: center;">
                                        {{ $status['name'] }}
                                    </span>
                                </td>
