...
<main id="mainContent">
    ...
    <div class="page-header">
        ...
        <h2 id="pageTitle">Edit Data Mitra</h2>
        <p id="pageDesc">Perbarui informasi instansi atau mitra kerjasama.</p>
    </div>

    <div class="modern-card">
        <form action="{{ route('unit.mitra.update', $mitra->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="mc-grid-2">
                    ...
                    <div class="mc-group">
                        ...
                        <div class="mc-input-wrap">
                            ...
                            <input type="text" name="nama_mitra" value="{{ old('nama_mitra', $mitra->nama_mitra) }}" required placeholder="Contoh: PT. Teknologi Maju Bersama" class="mc-input @error('nama_mitra') border-danger @enderror" />
                        </div>
                        @error('nama_mitra')
                        ...
                        <div class="mc-input-wrap">
                            ...
                            <select name="id_klasifikasi" class="mc-input @error('id_klasifikasi') border-danger @enderror">
                                ...
                                @forelse($klasifikasi ?? [] as $klas)
                                    <option value="{{ $klas->id }}" {{ old('id_klasifikasi', $mitra->id_klasifikasi) == $klas->id ? 'selected' : '' }}>{{ $klas->nama }}</option>
                                @empty
                                @endforelse
                            </select>
                        </div>
                    ...
                    <div class="mc-group" style="grid-column: 1 / -1;">
                        ...
                        <div class="mc-input-wrap">
                            ...
                            <textarea name="alamat" rows="2" placeholder="Masukkan alamat lengkap mitra..." class="mc-input" style="resize: vertical; min-height: 70px;">{{ old('alamat', $mitra->alamat) }}</textarea>
                        </div>
                        @error('alamat')
                            <span class="text-danger" style="font-size: 11px; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mc-group" x-data="{ 
                        open: false, 
                        selected: '{{ old('kategori', $mitra->kategori) }}',
                        items: [
                    ...
                    {{-- Negara --}}
                    <div class="mc-group" x-data="countryPicker()" x-init="selected = '{{ old('negara', $mitra->negara) }}'">
                    ...
                    <div class="mc-group">
                        ...
                        <div class="mc-input-wrap">
                            ...
                            <input type="text" name="telp" value="{{ old('telp', $mitra->telp) }}" placeholder="Contoh: 021-12345678" class="mc-input @error('telp') border-danger @enderror" />
                        </div>
                        @error('telp')
                            <span class="text-danger" style="font-size: 11px; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mc-group">
                        ...
                        <div class="mc-input-wrap">
                            ...
                            <input type="text" name="website" value="{{ old('website', $mitra->website) }}" placeholder="Contoh: https://www.example.com" class="mc-input @error('website') border-danger @enderror" />
                        </div>
                        @error('website')
                            <span class="text-danger" style="font-size: 11px; margin-top: 4px; display: block;">{{ $message }}</span>
                        @enderror
