            ...
            <div class="mc-body" style="padding: 30px;">
                <div class="mc-grid-2">
                    ...
                    <div class="mc-group" x-data="{
                        open: false,
                        search: '',
                        selected: '{{ old('id_klasifikasi', $mitra->id_klasifikasi ?? '') }}',
                        items: [
                ...
                <div id="mitraContainer"
                    x-data="{ kategori: '{{ old('kategori', $mitra->kategori ?? '') }}', negara: '{{ old('negara', $mitra->negara ?? 'Indonesia') }}' }">
                ...
                <div class="mc-group" style="margin-bottom: 16px;">
                    ...
                    <div class="mc-input-wrap">
                        ...
                        <textarea name="alamat" rows="2" placeholder="Masukkan alamat lengkap mitra..."
                            ...
                            style="resize: vertical; min-height: 70px;">{{ old('alamat', $mitra->alamat) }}</textarea>
                    </div>
                    @error('alamat')
                ...
                <div class="mc-grid-2">
                    ...
                    <div class="mc-group">
                        ...
                        <div class="mc-input-wrap">
                            ...
                            <input type="text" name="telp" value="{{ old('telp', $mitra->telp) }}"
                    ...
                    <div class="mc-group">
                        ...
                        <div class="mc-input-wrap">
                            ...
                            <input type="text" name="website" value="{{ old('website', $mitra->website) }}"
