    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function formatDate(dateStr) {
            ...
            try {
                ...
                var months = ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agt', 'Sep', 'Okt', 'Nov',
                    'Des'];
        ...
        function showLoading() {
            previewBody.innerHTML =
                '<tr><td colspan="6" style="text-align:center; padding: 40px 0;"><i class="fas fa-spinner fa-spin" style="font-size: 20px; color: var(--accent); opacity: 0.6;"></i><p style="margin-top: 10px; font-size: 12px; color: var(--text-sub);">Memuat data kerjasama...</p></td></tr>';
        }

        function showEmpty() {
            previewBody.innerHTML =
                '<tr><td colspan="6" class="um-empty"><div class="um-empty-state" style="padding:30px 0;"><div class="um-empty-icon"><i class="fas fa-inbox" style="font-size:28px; opacity:0.3; color:var(--text-sub);"></i></div><p class="um-empty-title">Tidak ada data ditemukan</p><p class="um-empty-sub">Coba ubah filter untuk menampilkan data lain.</p></div></td></tr>';
            previewCount.style.display = 'none';
        }

        function showError() {
            previewBody.innerHTML =
                '<tr><td colspan="6" class="um-empty"><div class="um-empty-state" style="padding:30px 0;"><p class="um-empty-title" style="color:#ef4444;">Gagal memuat data</p><p class="um-empty-sub">Terjadi kesalahan. Silakan coba lagi.</p></div></td></tr>';
        }
        ...
        function buildRow(item, idx) {
            ...
            if (status === 'aktif') {
                ...
                statusLabel = status.replace(/\b\w/g, function(l) {
            ...
            tr.innerHTML =
                ...
                '<span class="dk-doc-title" style="font-weight: 700; line-height: 1.5; display: block; overflow-wrap: break-word;">' +
                title + '</span>' +
