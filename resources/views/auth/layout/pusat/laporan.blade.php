<main id="mainContent">
    ...
    <div class="report-filter-container" x-data="{ showFilters: true }">
        ...
        <div class="rfc-body" x-show="showFilters" x-transition:enter="transition ease-out duration-300"
            ...
            <form id="filterForm" class="rfc-form" data-preview-url="{{ route('pusat.laporan.preview') }}"
                data-pdf-url="{{ route('pusat.laporan.pdf') }}" data-excel-url="{{ route('pusat.laporan.excel') }}">
