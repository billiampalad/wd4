    ...
    <div style="display: grid; grid-template-columns: 380px 1fr; gap: 24px; max-width: 1400px; margin: 24px auto; padding: 0 20px 40px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <a href="{{ route('pusat.mitra') }}" class="dk-secondary-btn" style="width: 100%; justify-content: center; height: 48px; border-radius: 12px; background: var(--surface2); color: var(--text); border: 1px solid var(--border);">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="um-actions dk-actions-compact">
                                            <a href="{{ route('pusat.kerjasama.show', $kegiatan->id) }}" class="dk-action-btn view" title="Detail Dokumen">
