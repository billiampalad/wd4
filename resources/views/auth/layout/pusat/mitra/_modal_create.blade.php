                        ...
                        <div class="mc-grid-2">
                                ...
                                <div class="alpine-dropdown" @click.outside="provinceOpen = false; provinceSearch = ''">
                                    <div class="ad-trigger" :class="{'active': provinceOpen}"
                                        ...
                                        <div class="mitra-create-trigger-content is-compact">
                                            ...
                                            <span x-show="!provinsi" class="mitra-create-placeholder">- Pilih Provinsi (Opsional / Otomatis) -</span>
                            ...
                            <div class="mc-group">
                                ...
                                <div class="mc-input-wrap">
                                    ...
                                    <input type="text" name="kota" placeholder="Contoh: Manado / Minahasa" class="mc-input">
                                </div>
                            </div>
                        </div>
                        <div class="mc-grid-2" style="margin-top: 12px;">
                            <div class="mc-group">
                                ...
                                <div class="mc-input-wrap">
                                    ...
                                    <input type="text" name="kecamatan" placeholder="Contoh: Tikala (Opsional)" class="mc-input">
                                </div>
                            </div>
                            <div class="mc-group">
                                <label class="mc-label">
                                ...
                                <div class="mc-input-wrap">
                                    ...
                                    <input type="text" name="kelurahan" placeholder="Contoh: Banjer (Opsional)" class="mc-input">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="kategori === 'internasional'" x-transition class="mitra-create-row">
                        <div class="mc-grid-2">
                            ...
                            <div class="mc-group">
                                ...
                                <div class="mc-input-wrap">
                                    <i class="fas fa-city mc-icon-left"></i>
                                    <input type="text" name="kota" placeholder="Contoh: Tokyo / Munich" class="mc-input">
                                </div>
                            </div>
                        </div>
                    </div>
