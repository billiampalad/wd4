...
<main id="mainContent">
    ...
    @if($kegiatan->status !== 'menunggu_validasi' && $kegiatan->status !== 'selesai')
        <form
            action="{{ $existingEval ? route('upa.evaluasi.update', $kegiatan->id) : route('upa.evaluasi.store', $kegiatan->id) }}"
    ...
    <div style="margin-bottom: 24px;">
        <a href="{{ route('upa.evaluasi') }}" class="rfc-btn"
