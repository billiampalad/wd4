<link rel="stylesheet" href="{{ asset('css/auth/unit/evaluasi.css') }}" data-turbo-track="reload">
...
<main id="mainContent">
            ...
            <div class="ud-title-row">
                ...
                <div class="ud-title-copy">
                    ...
                    <p class="ud-subtitle">
                        ...
                        <strong>{{ auth()->user()->profile?->upa?->nama_upa ?? 'UPA' }}</strong>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card-header um-header dk-card-header"
            ...
            <div class="um-title dk-card-title">
                ...
                <div>
                    ...
                    <span style="display:block; font-size:11px; font-weight:500; color:var(--text-sub);">Dokumen yang
                        baru diajukan & butuh kelengkapan berkas</span>
                </div>
            </div>
                        ...
                        @forelse(($draftList ?? collect()) as $kegiatan)
                            ...
                            <tr class="um-row dk-row">
                                ...
                                <td class="um-td dk-title-cell"
                                    style="width: 400px; vertical-align: top; padding-top: 15px;">
                                    <div class="dk-doc-cell" style="white-space: normal; word-break: break-word;">
                                        ...
                                        <span class="dk-doc-title"
                                            style="font-weight: 700; line-height: 1.5; display: block; overflow-wrap: break-word;">{{ $title ?: '-' }}</span>
                                ...
                                <td class="um-td" style="vertical-align: top; padding-top: 15px;">
                                    <div class="dk-entity" style="align-items: flex-start;">
                                        ...
                                        <span class="dk-entity-text"
                                            style="padding-top: 4px;">{{ $mitraName ?: '-' }}</span>
                                    </div>
                                </td>
                                <td class="um-td um-td-aksi"
                                    style="text-align:center; vertical-align: top; padding-top: 15px;">
                                    <a href="{{ route('upa.kerjasama.show', $kegiatan->id) }}" class="dk-primary-btn"
                                ...
                                <td colspan="5" class="um-empty">
                                    <div class="um-empty-state">
                                        <i class="fas fa-folder-open"
                                            style="font-size: 24px; opacity: 0.2; margin-bottom: 10px;"></i>
    ...
    <div class="card um-card dk-card" style="margin-bottom: 24px;">
        <div class="card-header um-header dk-card-header"
            ...
            <div class="um-title dk-card-title">
                <div
                    style="width:32px; height:32px; border-radius:8px; background:rgba(239,68,68,0.12); color:#dc2626; display:flex; align-items:center; justify-content:center; font-size:14px;">
                    <i class="fas fa-pen-to-square"></i>
                </div>
                <div>
                    <span style="display:block; font-size:14px; font-weight: 700;">Perlu Revisi</span>
                    <span style="display:block; font-size:11px; font-weight:500; color:var(--text-sub);">Dokumen
                        dikembalikan oleh Pimpinan untuk diperbaiki</span>
                </div>
            </div>
                            ...
                            <tr class="um-row dk-row">
                                ...
                                <td class="um-td dk-title-cell"
                                    ...
                                    <div class="dk-doc-cell" style="white-space: normal; word-break: break-word;">
                                        ...
                                        @if($catatanRevisi)
                                            <div
                                                style="margin-top: 10px; padding: 10px 14px; background: rgba(239,68,68,0.05); border-left: 3px solid #ef4444; border-radius: 0 8px 8px 0; font-size: 12px; line-height: 1.6; color: var(--text);">
                                                <div
                                                    style="font-weight: 700; font-size: 10px; text-transform: uppercase; letter-spacing: 0.04em; color: #dc2626; margin-bottom: 4px;">
                                                    <i class="fas fa-comment-dots" style="margin-right: 4px;"></i> Catatan
                                                    Pimpinan
                                                </div>
                                ...
                                <td colspan="5" class="um-empty">
                                    <div class="um-empty-state">
                                        <i class="fas fa-circle-check"
                                            style="font-size: 24px; opacity: 0.4; color: #10b981; margin-bottom: 10px;"></i>
                                        <p class="um-empty-title" style="font-size: 13px;">Tidak ada dokumen yang perlu
                                            direvisi</p>
                                    </div>
                                </td>
                            </tr>
    ...
    <div class="card um-card dk-card" style="margin-bottom: 24px;">
        <div class="card-header um-header dk-card-header"
            style="background: linear-gradient(135deg, rgba(79,70,229,0.06), rgba(6,182,212,0.03));">
            <div class="um-title dk-card-title">
                <div
                    style="width:32px; height:32px; border-radius:8px; background:rgba(79,70,229,0.12); color:#4f46e5; display:flex; align-items:center; justify-content:center; font-size:14px;">
                    <i class="fas fa-clipboard-check"></i>
                </div>
                <div>
                    <span style="display:block; font-size:14px; font-weight: 700;">Menunggu Evaluasi</span>
                    <span style="display:block; font-size:11px; font-weight:500; color:var(--text-sub);">Dokumen yang
                        sudah lengkap dan siap dinilai kinerjanya</span>
                </div>
            </div>
        ...
        <div class="card-header um-header dk-card-header"
            ...
            <div class="um-title dk-card-title">
                ...
                <div>
                    ...
                    <span style="display:block; font-size:11px; font-weight:500; color:var(--text-sub);">Arsip evaluasi
                        yang telah diselesaikan</span>
                </div>
            </div>
        </div>
        <div class="card-body dk-card-body" style="padding: 0;">
                            ...
                            <tr class="um-row dk-row">
                                ...
                                <td class="um-td" style="vertical-align: top; padding-top: 15px;">
                                    <div style="display: flex; align-items: center; gap: 8px;">
                                        <div
                                            style="flex: 1; height: 6px; background: var(--surface2); border-radius: 10px; overflow: hidden; min-width: 60px;">
                                            <div
                                                style="width: {{ ($avgScore / 5) * 100 }}%; height: 100%; background: {{ $avgScore >= 4 ? '#10b981' : ($avgScore >= 3 ? '#f59e0b' : '#ef4444') }};">
                                            </div>
                                        </div>
                                        <span
                                            style="font-family:'DM Mono',monospace; font-size:12px; font-weight:700;">{{ $avgScore }}/5</span>
                                    </div>
                                </td>
                                <td class="um-td um-td-aksi"
                                    style="text-align:center; vertical-align: top; padding-top: 15px;">
                                    <a href="{{ route('upa.kerjasama.show', $kegiatan->id) }}" class="dk-action-btn view"
                                        title="Lihat Detail">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="um-empty">
                                    <div class="um-empty-state">
                                        <p class="um-empty-title" style="font-size: 12px; color: var(--text-sub);">Belum ada
                                            riwayat pengesahan</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
