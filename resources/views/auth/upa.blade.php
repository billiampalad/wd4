...
<html lang="id" data-theme="light"
    class="{{ request()->routeIs('upa.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }} {{ request()->routeIs('upa.institusi') ? 'institusi-page' : '' }} {{ request()->routeIs('upa.evaluasi') ? 'evaluasi-kinerja-page' : '' }}">
