...
<html lang="id" data-theme="light"
    class="{{ request()->routeIs('upa.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }}">
...
<body class="{{ request()->routeIs('upa.analitik.status-kerjasama') ? 'status-kerjasama-page' : '' }}">
