...
@section('content')
    <main class="main-content admin-dashboard">
                            ...
                            <tr class="um-row">
                                ...
                                <td class="um-td um-td-aksi">
                                    <div class="actions um-actions">
                                        ...
                                        <form id="form-delete-upelaksana-{{ $upelaksana->id }}"
                                            action="{{ route('upelaksana.destroy', $upelaksana->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
        ...
        <div id="createUnitModal" class="adm-modal-overlay" style="display: none;"
            onclick="AdminModal.handleOverlayClick(event, 'createUnitModal')">
            <div class="adm-modal-container adm-modal-sm">
                <div class="adm-modal-header">
                    ...
                    <button type="button" class="adm-modal-close" onclick="AdminModal.close('createUnitModal')"
                        title="Tutup">
                    ...
                    <div class="adm-modal-body">
                        <div class="adm-form-group">
                            <label class="adm-form-label" for="create_nama_unit_pelaksana">
                                <i class="fas fa-building"></i> Nama Unit Pelaksana Humas <span
                                    class="adm-required">*</span>
                            </label>
                            <input type="text" id="create_nama_unit_pelaksana" name="nama_unit_pelaksana"
                                class="adm-form-input" placeholder="Contoh: Humas dan Kerjasama, dsb" required
                                maxlength="255">
                        </div>
                    </div>
        ...
        <div id="editUnitModal" class="adm-modal-overlay" style="display: none;"
            onclick="AdminModal.handleOverlayClick(event, 'editUnitModal')">
            <div class="adm-modal-container adm-modal-sm">
                <div class="adm-modal-header">
                    <div class="adm-modal-title-wrap">
                ...
                <form action="" method="POST" id="editUnitForm">
                    ...
                    <div class="adm-modal-body">
                        <div class="adm-form-group">
                            ...
                            <input type="text" id="edit_nama_unit_pelaksana" name="nama_unit_pelaksana"
                                class="adm-form-input" placeholder="Ubah nama unit pelaksana humas" required
                                maxlength="255">
                        </div>
                    </div>
                    <div class="adm-modal-footer">
