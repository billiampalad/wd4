    ...
    <section class="ud-topbar">
        <div class="ud-hero-copy">
            <div class="ud-breadcrumb">
                ...
                <span>/</span>
                <a href="{{ route('users.index') }}" class="ud-breadcrumb-link">Users</a>
                <span>/</span>
            ...
            <div class="ud-title-row">
                ...
                <div class="ud-title-copy">
                    <h2 class="ud-title" id="pageTitle">Tambah Pengguna Baru</h2>
                            ...
                            <div class="uc-form-group">
                                ...
                                >
                                    <select
                                        ...
                                        class="uc-native-select @error('role_id') uc-input-error @enderror"
                            ...
                            <div class="uc-form-group" data-profile-field="jurusan">
                                ...
                                <div
                                    ...
                                    x-data="adminUserSelect({
                                        ...
                                        selectedValue: @js((string) old('jurusan_id', '')),
                            ...
                            <div class="uc-form-group" data-profile-field="prodi">
                                ...
                                <div
                                    ...
                                    x-data="adminUserSelect({
                                        ...
                                        filterJurusan: true,
                                        currentJurusanId: @js((string) old('jurusan_id', '')),
                            ...
                            <div class="uc-form-group" data-profile-field="unit">
                                ...
                                <div
                                    ...
                                    x-data="adminUserSelect({
                                        ...
                                        selectedValue: @js((string) old('unit_kerja_id', '')),
