    ...
    <main id="mainContent">
        <div class="page-header">
            <div class="breadcrumb">
                <i class="fas fa-microchip" style="font-size:11px;"></i>
                <span class="sep">/</span>
                <span style="color: inherit; text-decoration: none;">Master Data</span>
                <span class="sep">/</span>
                <a href="{{ route('klasifikasi.index') }}" style="color: inherit; text-decoration: none;">Klasifikasi
                    Mitra</a>
                <span class="sep">/</span>
                <span class="current">Tambah</span>
            </div>
            <h2 id="pageTitle">Tambah Klasifikasi Mitra</h2>
            <p id="pageDesc">Isi formulir untuk menambahkan klasifikasi mitra baru.</p>
        </div>
        ...
        <div style="width: 100%; max-width: 1200px; margin: 0 auto;">
            <div class="modern-card">
                <div class="mc-header">
                    ...
                    <div class="mc-title">
                        <h3>Formulir Klasifikasi Baru</h3>
                        <p>Silakan lengkapi data klasifikasi mitra di bawah ini.</p>
                    </div>
                </div>
