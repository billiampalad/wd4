    ...
    <div class="card um-card">
        <div class="card-header um-header">
            ...
            <div class="um-header-actions">
                <x-search id="mitraSearchInput" placeholder="Cari data mitra..." target=".um-table tbody tr.um-row"
                    emptyTarget="#mitraSearchEmptyRow" querySpan="#mitraSearchQueryText" />
        ...
        <div class="table-wrap um-table-wrap">
            <table class="um-table">
                ...
                <tbody>
                    ...
                    @endforelse
                    <tr id="mitraSearchEmptyRow" style="display: none;">
                        <td colspan="8" class="um-empty">
                            <div class="um-empty-state">
                                ...
                                <p class="um-empty-sub">Tidak ada mitra yang cocok dengan kata kunci "<span
                                        id="mitraSearchQueryText"
        ...
        <x-paginav id="mitraTablePaginav" target=".um-table tbody tr.um-row" :perPage="10" :showInfo="true"
            :showPerPage="false" />
    </div>
