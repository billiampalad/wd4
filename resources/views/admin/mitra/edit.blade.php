            ...
            <div class="ud-title-row">
                ...
                <div class="ud-title-copy">
                    ...
                    <p class="ud-subtitle" id="pageDesc">
                        Perbarui informasi data mitra dengan tampilan seperti modal edit.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card uc-form-card mitra-page-card">
                <div class="mitra-create-header mitra-page-form-header">
                    ...
                    <div class="mitra-create-header-text">
                        <h3 class="mitra-create-title">Edit Data Mitra</h3>
                        <p class="mitra-create-subtitle">Perbarui informasi instansi mitra kerjasama</p>
                    </div>
                </div>

                <form action="{{ route('mitra.update', $mitra->id) }}" method="POST" x-data="adminMitraForm({
                    ...
                    <div class="mitra-create-content mitra-page-form-content">
                        ...
                        <div class="mc-grid-2 mitra-create-row">
                            <div class="mc-group">
                                ...
                                <div class="mc-input-wrap">
                                    <input type="text" name="nama_mitra" required placeholder="Masukkan nama instansi/mitra" class="mc-input no-icon @error('nama_mitra') uc-input-error @enderror" value="{{ old('nama_mitra', $mitra->nama_mitra) }}">
                                </div>
                                @error('nama_mitra')
                                <span class="mitra-create-error"><i class="fas fa-circle-exclamation"></i> {{ $message }}</span>
                                @enderror
                        ...
                        <div class="mc-group mitra-create-row">
                            ...
                            <div class="mc-input-wrap">
                                ...
                                <textarea name="alamat" rows="2" placeholder="Masukkan alamat lengkap mitra..." class="mc-input mitra-create-textarea @error('alamat') uc-input-error @enderror">{{ old('alamat', $mitra->alamat) }}</textarea>
                            </div>
                            @error('alamat')
                            <span class="mitra-create-error"><i class="fas fa-circle-exclamation"></i> {{ $message }}</span>
                            @enderror
                        ...
                        <div class="mc-grid-2">
                            <div class="mc-group">
                                ...
                                <div class="mc-input-wrap">
                                    ...
                                    <input type="text" name="telp" placeholder="Contoh: 021-12345678" class="mc-input @error('telp') uc-input-error @enderror" value="{{ old('telp', $mitra->telp) }}">
                                </div>
                                @error('telp')
                                <span class="mitra-create-error"><i class="fas fa-circle-exclamation"></i> {{ $message }}</span>
                                @enderror
                            ...
                            <div class="mc-group">
                                ...
                                <div class="mc-input-wrap">
                                    ...
                                    <input type="text" name="website" placeholder="https://www.example.com" class="mc-input @error('website') uc-input-error @enderror" value="{{ old('website', $mitra->website) }}">
                                </div>
                                @error('website')
                                <span class="mitra-create-error"><i class="fas fa-circle-exclamation"></i> {{ $message }}</span>
                                @enderror
                    ...
                    <div class="mitra-create-footer mitra-page-form-footer">
                        ...
                        <button type="submit" class="mitra-create-btn mitra-create-btn-primary">
                            <span class="mitra-create-btn-content"><i class="fas fa-save"></i> Perbarui Mitra</span>
                        </button>
                    </div>
                </form>
            </div>
