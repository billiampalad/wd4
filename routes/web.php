...
Route::middleware(['auth', 'role:prodi'])->group(function () {
    ...
    Route::get('/prodi/mahasiswa-magang', [\App\Http\Controllers\Prodi\PenempatanMahasiswaController::class, 'index'])->name('prodi.penempatan.mahasiswa-magang');
    ...
    Route::delete('/prodi/alumni/{id}', [\App\Http\Controllers\Prodi\AlumniMitraController::class, 'destroy'])->name('prodi.alumni.destroy');
