...
class KerjasamaUpaController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('auth.upa', compact('mitras', 'jurusans', 'prodis', 'upas', 'pusats', 'allowedTipePelaksana', 'jenisKerjasama', 'sasarans', 'indikators', 'perpanjanganAsal'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            UnitKerjaNotifications::sendNewCooperation($cooperation, Auth::user(), 'upa');
    ...
    public function edit($id)
    {
        ...
        return view('auth.upa', compact('kegiatan', 'mitras', 'jurusans', 'prodis', 'upas', 'pusats', 'allowedTipePelaksana', 'jenisKerjasama', 'sasarans', 'indikators'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('Upa Update Error: ' . $e->getMessage());
    ...
    public function submitToPimpinan($id)
    {
        ...
        // Validasi profil UPA yang sedang login.
        if (!$profile->upa_id) {
        ...
        try {
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('Upa Submit Error: ' . $e->getMessage());
