...
class PusatPageController extends Controller
{
    /**
     * Resolve the pusat_id for the currently logged-in user.
     */
    private function resolveUnitId()
    {
        ...
        return $profile->pusat_id;
    }

    /**
     * Helper: scope query to kegiatan belonging to this pusat.
     */
    ...
    public function statusKerjasama(Request $request)
    {
        ...
        return view('auth.pusat', compact(
            'statusKerjasamaData',
            'growthData',
            'growthAverages',
            'calendarData',
        ...
        return [
            ...
            'rows' => $dueDateCooperations->map(function ($cooperation) {
                return [
                    ...
                    'detail_url' => route('pusat.kerjasama.show', $cooperation->id),
    ...
    public function institusi()
    {
        ...
        return view('auth.pusat', compact('instansi', 'jurusans', 'upas', 'pusats', 'mouCount', 'moaCount', 'iaCount'));
    }
    ...
    public function statusKerjasamaReferensi()
    {
        ...
        return view('auth.pusat', ['referensiStatus' => $statusList]);
    }
    ...
    public function statusEvaluasiReferensi()
    {
        ...
        return view('auth.pusat', ['referensiStatusEvaluasi' => $statusList]);
    }
    ...
    public function kriteriaMitraReferensi()
    {
        ...
        return view('auth.pusat', compact('kriterias'));
    }
    ...
    public function klasifikasiMitra()
    {
        ...
        $topMitras = \App\Models\Mitra::whereIn('id', $mitraIds)
            ->withCount([
                'cooperations as cooperations_count' => fn ($query) => $this->scopeUnit($query, $unitId),
            ])
    ...
    public function mitra()
    {
        ...
        return view('auth.pusat', compact('mitras'));
    }
    ...
    public function mitraStore(Request $request)
    {
        ...
        return redirect()->route('pusat.mitra')->with('success', 'Mitra berhasil ditambahkan.');
    }
    ...
    public function mitraShow($id)
    {
        ...
        return view('auth.pusat', compact('mitra'));
    }
    ...
    public function mitraEdit($id)
    {
        ...
        return view('auth.pusat', compact('mitra', 'klasifikasi'));
    }
    ...
    public function mitraUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('pusat.mitra')->with('success', 'Data mitra berhasil diperbarui.');
    }
    ...
    public function mitraDestroy(Request $request, $id)
    {
        ...
        return redirect()->route('pusat.mitra')->with('success', 'Mitra berhasil dihapus.');
    }
    ...
    public function storeEvaluasi(Request $request, $id)
    {
        ...
        return redirect()->route('pusat.evaluasi')->with('success', 'Evaluasi berhasil dikirim ke Pimpinan untuk divalidasi.');
    }
    ...
    public function updateEvaluasi(Request $request, $id)
    {
        ...
        return redirect()->route('pusat.evaluasi')->with('success', 'Evaluasi berhasil diperbarui dan dikirim ke Pimpinan.');
    }
    ...
    public function laporanPdf(Request $request)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('auth.layout.pusat.laporan_pdf', compact('data'));
        return $pdf->download('laporan_kerjasama_pusat.pdf');
    }
    ...
    public function laporanExcel(Request $request)
    {
        ...
        return \Maatwebsite\Excel\Facades\Excel::download(new \App\Exports\LaporanKerjasamaExport($data, 'auth.layout.pusat.laporan_excel'), 'laporan_kerjasama_pusat.xlsx');
    }
    ...
    public function formLaporanStore(Request $request)
    {
        ...
        return redirect()->route('pusat.form')->with('success', 'Laporan berhasil diupload.');
    }
