...
class KerjasamaPusatController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('auth.pusat', compact('mitras', 'jurusans', 'prodis', 'upas', 'pusats', 'allowedTipePelaksana', 'jenisKerjasama', 'sasarans', 'indikators', 'perpanjanganAsal'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $cooperation = Cooperation::create([
                ...
                'tingkat' => 'Pusat/UPA',
                'jurusan_id' => ('Pusat/UPA' === 'jurusan' && $request->pelaksana_jurusan_ids) ? $request->pelaksana_jurusan_ids[0] : null,
                'upa_id' => ('Pusat/UPA' === 'upa' && $request->pelaksana_upa_ids) ? $request->pelaksana_upa_ids[0] : null,
                'pusat_id' => ('Pusat/UPA' === 'pusat' && $request->pelaksana_pusat_ids) ? $request->pelaksana_pusat_ids[0] : null,
            ]);
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('Pusat Store Error: ' . $e->getMessage());
    ...
    public function edit($id)
    {
        ...
        return view('auth.pusat', compact('kegiatan', 'mitras', 'jurusans', 'prodis', 'upas', 'pusats', 'allowedTipePelaksana', 'jenisKerjasama', 'sasarans', 'indikators'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('Pusat Update Error: ' . $e->getMessage());
    ...
    public function submitToPimpinan($id)
    {
        ...
        try {
            ...
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('Pusat Submit Error: ' . $e->getMessage());
