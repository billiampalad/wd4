...
class KerjasamaJurusanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            UnitKerjaNotifications::sendNewCooperation($cooperation, Auth::user(), 'jurusan');

            DB::commit();
            return redirect()->route('jurusan.dkerjasama')->with('success', 'Data kerjasama berhasil disimpan.');
        } catch (\Exception $e) {
            DB::rollBack();
            \Illuminate\Support\Facades\Log::error('Jurusan Store Error: ' . $e->getMessage());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $cooperation->update([
                ...
                'parent_cooperation_id' => $request->parent_cooperation_id,
                'perpanjangan_dari_id' => $request->perpanjangan_dari_id ?? $cooperation->perpanjangan_dari_id,
                'document_link' => $request->document_link,
                'internal_instansi' => $request->nama_instansi ?? 'Politeknik Negeri Manado',
                'mitra_id' => $mitraId,
